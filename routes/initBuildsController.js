...
router.get('/init', (req, res) => {
    ...
    tmp.save((err, docs) => {if(err) console.log("Build error : " + err)})
    // Xiangling DPS                                                            DONE
    tmp = new BuildENModel({
